module.exports = {
	fruits: [{ value: "Apple", label: "Apple", color: ["Red", "Green", "Yellow"], growsOn: "Tree", size: "big", tooltipContent: "<h5>Fruit name: </h5>Apple<h5>Fruit Description: </h5>Apples are awesome."},
			 { value: "Banana", label: "Banana", color: "Yellow", growsOn: "Tree", size: "big", customOptionTag:"<span style=\"color: yellow; display: inline; padding: 2px 4px; font-size: 10px; border: solid 1px gold; border-radius: 2px;\">Yummy</span>"},
